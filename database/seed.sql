...
VALUES
  ('p1', 'پروژه نوسازی مدارس', 'تهران، جردن، اداره کل نوسازی مدارس', 'فعال', 'پروژه مدارس و نوسازی فضاهای آموزشی', 'u1'),
  ('p2', 'پروژه صنعت نفت', 'خیابان به آفرین، بهداشت و درمان صنعت نفت', 'فعال', 'مأموریت‌های مرتبط با پروژه نفت و خدمات فنی', 'u1'),
  ('p3', 'پروژه عمومی و اداری', 'دفتر مرکزی شرکت', 'فعال', 'پروژه‌های اداری و خدمات عمومی', 'u1');
